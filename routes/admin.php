...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function (): void {
    ...
    Route::get('/scan', [DirektoriGuruController::class, 'index'])->name('scan.index');
    Route::get('/scan/{user}/edit', [ProfilPenggunaController::class, 'edit'])->name('scan.edit');
    Route::put('/scan/{user}', [ProfilPenggunaController::class, 'update'])->name('scan.update');
